...
def process_image_file(image_file, input_folder, output_folder, edited_folder, records):
...
def main():
    ...
    records = []  # List of dicts to hold extracted data for Excel

    for filename in os.listdir(input_folder):
        if filename.lower().startswith("gd-") and filename.lower().endswith((".png", ".jpg", ".jpeg")):
            print(f"\n=== Processing File: {filename} ===")
            process_image_file(filename, input_folder, output_folder, edited_folder, records)
